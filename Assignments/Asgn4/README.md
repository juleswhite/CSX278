...
Docker Compose does not behave identically on Windows and Linux/Mac. Due to some current differences (bugs) in behavior, adjustments are needed to the docker-compose.yml file generated by JHipster. Please download the updated Docker Compose file from this folder. On the last step, you will need to make a backup copy of your JHipster generated file (that you will submit for grading) and then replace it with the windows-docker-compose.yml file in this folder. 
...
__Windows Users:__ Make a copy of the generated docker-compose.yml file to submit for your assignment solution. Then, replace the generated docker-compose.yml file with the windows-docker-compose.yml file in this directory.
...
You can access the registry at: http://localhost:8761
