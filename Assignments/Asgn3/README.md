...
+ Create a Dockerfile on the folder containing you _JHipster_ solution.
+ As explained in the [reading material](https://docs.docker.com/engine/getstarted/step_four/) edit the `Dockerfile` to base your new image off `openjdk:8`
